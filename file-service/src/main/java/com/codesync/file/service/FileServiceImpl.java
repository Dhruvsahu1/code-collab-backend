...
import com.codesync.file.feign.ProjectClient;
...
public class FileServiceImpl implements FileService {
    ...
    public FileServiceImpl(FileRepository fileRepository, ProjectClient projectClient) {
    ...
    private void validateProject(Long projectId) {
        try {
            ResponseEntity<Object> response = projectClient.getProject(projectId);
